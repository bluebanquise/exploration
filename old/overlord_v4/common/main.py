...
# def overlord_page_render(
#     ui_skeleton: Dict[str, Any],
#     current_section: str,
#     template_name: str,
#     **context: Any,
# ):
#     """
#     Render a plugin page inside the main layout.

#     - ui_skeleton: merged dict from plugins
#     - current_section: navbar section (e.g. "inventory")
#     - template_name: plugin template to include (full path relative to Flask templates search paths)
#     - context: extra context for the plugin template
#     """
...
def overlord_page_render(ui_skeleton, current_section, template_name, **kwargs):
    """
    Render a plugin page that extends main.j2.
    ui_skeleton is kept for compatibility but no longer used directly.
    """
    return render_template(
        template_name,
        current_section=current_section,
